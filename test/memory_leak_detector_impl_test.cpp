...
class memory_leak_detector_impl_test : public ::testing::Test
{
public:
    memory_leak_detector_impl_test()
        : sut(1, argv)
    {

    }

    virtual ~memory_leak_detector_impl_test() noexcept = default;
    memory_leak_detector_impl_test(const memory_leak_detector_impl_test&) = delete;
    memory_leak_detector_impl_test& operator=(const memory_leak_detector_impl_test&) = delete;
    memory_leak_detector_impl_test(memory_leak_detector_impl_test&&) = delete;
    memory_leak_detector_impl_test& operator=(memory_leak_detector_impl_test&&) = delete;
...
TEST_F(memory_leak_detector_impl_test, 
